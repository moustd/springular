...
OpenAPI definition
- API version: v0
  - Build date: 2021-02-20T15:39:25.952+10:30[Australia/Adelaide]
...
public class GreetingControllerApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            String result = apiInstance.greeting(name);
...
------------ | ------------- | ------------- | -------------
*GreetingControllerApi* | [**greeting**](docs/GreetingControllerApi.md#greeting) | **GET** /greeting | 
